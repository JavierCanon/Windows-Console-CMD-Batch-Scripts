@if (@X)==(@Y) @end /* Hybrid line that begins a JScript comment

:: Remove duplicate lines from any text-based file, while keeping blank lines.
:: Created by Th.dub @ResonantStep 2019
:: Credits goes to dbenham for his awesome JRepl.bat utility
:: Just drag and drop your file on to this script
:: Supports files with ASCII, UTF-8 and UNICODE character encoding

@echo off
if exist "%TEMP%\lock_process.tmp" ( goto :Batch)
